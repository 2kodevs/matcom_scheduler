...
ACTIVE_CREATE   = '⚠️ Antes de comenzar una nueva votación debe cerrar la que está teniendo lugar actualmente.'
...
LIST_MESSAGE = '📊 Los modelos son los diferentes algoritmos que el bot utiliza para determinar el resultado final de cada votación.\n\n📍La lista de los modelos disponibles en este momento es:\n %s \n\n❗️Actualmente se encuentra seleccionado el modelo: %s.'
...
REGISTERED = '🙋 Usted ha sido registrado como votante. Escriba /vote en el chat privado para emitir su voto.'
START_SELECTION = '📍Por favor, seleccione el grupo donde está ocurriendo la votación en la que desea participar.'
VOTING_IN = '🗳 Usted está votando en la votación del grupo "%s".\n\n❓Utilice los botones para agregar una opción al final de la lista o remover una opción ya seleccionada. Marque Cancelar para descartar su voto. Una vez agregadas todas las opciones de la encuesta a su lista en el orden deseado, marque Confirmar para emitir su voto.'
